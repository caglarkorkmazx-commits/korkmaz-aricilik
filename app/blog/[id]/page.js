...
export default function BlogDetailPage() {
  ...
  if (loading) return <div style={{ color: '#fff', padding: '100px', textAlign: 'center' }}>Yükleniyor...</div>
  if (!blog) return <div style={{ color: '#fff', padding: '100px', textAlign: 'center' }}>Yazı bulunamadı.</div>

  return (
    <article style={{ maxWidth: '800px', margin: '0 auto', padding: '60px 20px', minHeight: '80vh' }}>
      <Link href="/blog" style={{ color: '#f59e0b', textDecoration: 'none', fontSize: '14px', display: 'inline-block', marginBottom: '20px' }}>
